...
struct Objection
{
  ...
  /* @method total returns the total number of objection objects created. */
  ...
  /* @method monitor_objections shuts down after all objections dropped and reached drain time. */
